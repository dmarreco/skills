...
| **confluence-writer** | Create/update pages in your personal Confluence space. Same credentials as confluence-reader; writes only with explicit user authorization. |
